  ...
  return (
    <div className="w-11/12 max-w-[1168px] md:p-8  mx-auto flex md:flex-row flex-col p-2 gap-2">
      ...
      <div className="bg-green-100 w-full rounded-3xl md:p-4 p-2">
        ...
        <form className="rounded-2xl p-6  opacity-70 " data-aos="fade-up">
          <label
            htmlFor="firstName"
          ...
          <div className="md:w-[20%] w-full relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
